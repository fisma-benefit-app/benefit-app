  ...
  return (
    <div className="flex flex-col border-2 p-4 mb-2 bg-white">
      ...
      <div className="flex flex-row gap-2 mt-3 justify-center">
        ...
        >
          {translation.functionalPointSummary.csv} <FontAwesomeIcon icon={faDownload} />
        </button>
        <button
          onClick={handleExportPdf}
          className="px-4 py-2 bg-fisma-blue hover:bg-fisma-dark-blue text-white cursor-pointer text-sm sm:text-base"
        >
          {translation.functionalPointSummary.calculationReport} <FontAwesomeIcon icon={faDownload} />
        </button>
      </div>
    </div>
  );
