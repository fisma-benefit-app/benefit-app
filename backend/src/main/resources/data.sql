...
insert into functional_component (id, class_name, component_type, data_elements, reading_references, writing_references,
                                  functional_multiplier, operations, degree_of_completion, comment, previous_FC_id , project_id, order_position)
values (1, 'Interactive end-user input service', '1-functional', 2, 4, 2, null, 3, 0.12, 'hakijan syöte', 1, 99, 1),
       (5, 'Interactive end-user input service', '1-functional', 2, 4, 2, null, 3, 0.34, 'montako tulee', 5, 100, 2),
       (6, 'Interactive end-user input service', '1-functional', 2, 4, 2, null, 3, 0.5, 'valittavana kaupungit', 6, 101, 3);
